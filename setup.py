...
setup(
    ...
    version=youtrackapipowerpack.__version__,
    url='https://github.com/davispeixoto/youtrack-api-powerpack',
    license='MIT License',
    ...
    description='Jetbrains YouTrack API power pack',
    long_description=long_description,
    packages=['youtrackapipowerpack'],
